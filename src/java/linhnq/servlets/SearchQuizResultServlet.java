 ...
 * @author quocl
 */
@WebServlet(name = "SearchQuizResultServlet", urlPatterns = {"/SearchQuizResultServlet"})
public class SearchQuizResultServlet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(SearchQuizResultServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TblQuizResultDTO> listQuizHistory = dao.loadQuizHistory(subject, user.getEmail());
