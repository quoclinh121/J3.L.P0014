...
public class CreateAccountServlet extends HttpServlet {
    ...
    private final String EMAIL_IS_EXISTED = "sign_up.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.isExistedEmail(email)) {
                request.setAttribute("EXISTED_EMAIL", "Email: " + email + " is existed!");
            } else {
                //Hash SHA256
                password = HashSHA256.toHexString(HashSHA256.getSHA(password));

                TblUsersDTO dto = new TblUsersDTO(email, name, password, "student", "New");
